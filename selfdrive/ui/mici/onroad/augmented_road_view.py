...
from openpilot.selfdrive.ui.mici.onroad.lead_follow_hud import LeadFollowHUD
...
class AugmentedRoadView(CameraView):
  def __init__(self, bookmark_callback=None, stream_type: VisionStreamType = VisionStreamType.VISION_STREAM_ROAD):
    ...
    self._lead_follow_hud = LeadFollowHUD()
  ...
  def _render(self, _):
    ...
    self._lead_follow_hud.render(self._content_rect)
