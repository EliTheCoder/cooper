...
from openpilot.selfdrive.ui.mici.onroad.lead_follow_indicator import LeadFollowIndicator
...
class AugmentedRoadView(CameraView):
  def __init__(self, bookmark_callback=None, stream_type: VisionStreamType = VisionStreamType.VISION_STREAM_ROAD):
    ...
    self._lead_follow_indicator = LeadFollowIndicator()
  ...
  def _render(self, _):
    ...
    self._lead_follow_indicator.render(self._content_rect)
